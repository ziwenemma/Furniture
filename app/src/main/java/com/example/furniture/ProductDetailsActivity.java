...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mProRate=(TextView)findViewById(R.id.product_rating_de);
        ...
        mdatabasereference.child(mPost_key).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                String post_desc=(String)snapshot.child("width").getValue();
                String post_price=(String)snapshot.child("price").getValue();
                String post_rate=(String)snapshot.child("rate").getValue();
